...
echo "● Instalar e configurar o proxy socks na porta 80 para permitir conexões SSH para este servidor" ; tput sgr0
echo "● Configurar o OpenSSH para rodar na porta 22 deixando a porta 443 para o OpenVPN" ; tput sgr0
